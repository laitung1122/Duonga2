...
function UICreator:CreateWindow()
    local Window = shared.Library:CreateWindow({
        Title = "Dương Api v2 | " .. shared.ScriptName,
        Center = true,
        AutoShow = true,
        Resizable = true,
        NotifySide = "Right",
...
function UICreator:CreateSettingsTab()
    ...
    MenuGroup:AddButton("Join Discord", function()
        ...
        Inviter.Join("https://discord.com/invite/mMQs6CZ9")
        Inviter.Prompt({
            name = "Nhóm test",
            invite = "https://discord.com/invite/mMQs6CZ9",
        })
    end):AddButton("Copy Link", function()
        if setclipboard then
            setclipboard("https://discord.com/invite/mMQs6CZ9")
            shared.Library:Notify("Copied discord link to clipboard!")
        else
            shared.Library:Notify("Discord link: https://discord.com/invite/mMQs6CZ9", 10)
        end
    end)
